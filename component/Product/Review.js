          ...
          <div className={`row text-start text-center`}>
            <div className={`col-md-12 mx-auto`}>
              <div className='commnHeading'>
                ...
                <div className='title-36 font-secondary mb-0 text-primary font-weight-700'>Trusted by the <span className='text-yellow fst-italic'>450 + Clients</span> Across India</div>
