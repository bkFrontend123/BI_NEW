                                    ...
                                    <div className={`mt-4 ${productStyle.tabChecklist}`}>
                                        ...
                                        <Row className='g-lg-5'>
                                            ...
                                            <Col lg={4}>
                                                <div className={`d-flex align-items-center ${productStyle.tabChecklistCard}`}>
                                                    <img src='/icons/check.svg' />
                                                    <p className={`ms-3 mb-0 mb-0 text-primaryDark font-weight-600 ${productStyle.tabChecklistCardTitle}`}>Helps attract & retain the best talent</p>
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                                                ...
                                                <Col lg={4}>
                                                    <div className={`pt-0 ${productStyle.lightYellowSecCardCol}`}>
                                                        <div className={`${productStyle.lightYellowSecCardBox}`}>
                                                            ...
                                                            <p className='title-18 font-weight-500 text-primaryDark m-0'>The D&O policy offers liability cover for company managers, officials, and directors to protect them from claims which may arise from the decisions and actions taken within the scope of their regular managerial duties.</p>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col lg={4}>
                                                    <div className={`${productStyle.lightYellowSecCardCol}`}>
                                                        <div className={`${productStyle.lightYellowSecCardBox}`}>
                                                            ...
                                                            <p className='title-18 font-weight-500 text-primaryDark m-0'>When a company indemnifies (provides financial protection) its directors or officers for a covered claim under the policy, Side B Coverage ensures that the company is reimbursed for the expenses they've incurred during the process.</p>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col lg={4}>
                                                    <div className={`pb-0 border-0 ${productStyle.lightYellowSecCardCol}`}>
                                                        <div className={`${productStyle.lightYellowSecCardBox}`}>
                                                            ...
                                                            <p className='title-18 font-weight-500 text-primaryDark m-0'>It is designed to protect the company as a whole from certain legal claims, regardless of whether the directors or officers are directly involved in the underlying dispute. This coverage typically addresses two main areas: Employment Disputes & Security Related Issues.</p>
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
                                            ...
                                            <Col lg={7}>
                                                <div className={`${productStyle.inciTabPanelBoxLeft}`}>
                                                    ...
                                                    <div className='mb-4'>
                                                        ...
                                                        <div className='title-18 font-weight-500 text-primaryDark m-0'>Multiple employees initiated legal proceedings against the subsidiary of a policyholder in China claiming unpaid contractual benefits and economic compensation.</div>
                                                    </div>
                                                    <div className='mb-4'>
                                                        <div className='title-26 font-weight-600 text-primaryDark m-0'>Resolution</div>
                                                        <div className='title-18 font-weight-500 text-primaryDark m-0'>The litigation was in China and the Insurer appointed a law firm in China for translation and better defense strategy. The outcome of the litigation was favourable and only the defense cost was incurred which was reimbursed under the policy.</div>
                                                    </div>
                                                </div>
                                            </Col>
                                        ...
                                        <Row className='g-4'>
                                            <Col lg={7}>
                                                <div className={`${productStyle.inciTabPanelBoxLeft}`}>
                                                    ...
                                                    <div className='mb-4'>
                                                        <div className='title-26 font-weight-600 text-primaryDark m-0'>Incident</div>
                                                        <div className='title-18 font-weight-500 text-primaryDark m-0'>FIR filed by ex-employee against 7 directors for cheating and unfair trade practices. The matter is in litigation before the Trial Court.</div>
                                                    </div>
                                                    <div className='mb-4'>
                                                        <div className='title-26 font-weight-600 text-primaryDark m-0'>Resolution</div>
                                                        <div className='title-18 font-weight-500 text-primaryDark m-0'>The law firm handling the litigation is appointed by the insurer to manage the defense of directors and all the defense costs are being borne by the insurer.</div>
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col lg={5} className='col-lg-5 ps-lg-5 text-end'>
