              ...
              <div className='mblMenu'>
                <svg xmlns="http://www.w3.org/2000/svg" width="37.263" height="23.304" viewBox="0 0 37.263 23.304">
                  <g id="Group_2935" data-name="Group 2935" transform="translate(-310.737 -79.519)">
                    <path id="Path_46" data-name="Path 46" d="M0,0H26.517" transform="translate(319.982 81.019)" fill="none" stroke="#351562" stroke-linecap="round" stroke-width="3"/>
                    <path id="Path_47" data-name="Path 47" d="M0,0H20.689" transform="translate(325.811 91.17)" fill="none" stroke="#351562" stroke-linecap="round" stroke-width="3"/>
                    <path id="Path_48" data-name="Path 48" d="M0,0H34.263" transform="translate(312.237 101.322)" fill="none" stroke="#351562" stroke-linecap="round" stroke-width="3"/>
                  </g>
                </svg>
              </div>
            </Col>
