                ...
                <div className={`container infrmtnCntntDiv pt-0`}>
                    <div className={`row `}>
                        <div className={`col-md-10 mx-auto`}>
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Disclosure of Personal Information</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Supplemental Information</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Links and Co-Branded Sites</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Security Policy</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>User Names and Passwords</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>COOKIES &amp; WEB BEACONS</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Third-Party Advertisement Servers:</h3>
                            <hr className='bg-gray mt-2' />
                            ...
                            <h3 className='title-32 font-secondary font-weight-700 text-black m-0'>Change in Policy</h3>
                            <hr className='bg-gray mt-2' />
